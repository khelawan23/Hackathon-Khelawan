...
async function followUser(userId, token) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/api/follow/${userId}`, {
        method: 'POST',
        token
    });
}
...
async function getFollowStatus(userId, token) {
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/api/follow/${userId}/status`, {
        method: 'GET',
        token
    });
    return response.isFollowing;
}
async function getUserFollowers(userId, token) {
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/api/follow/${userId}/followers`, {
        method: 'GET',
        ...token && {
            token
        }
...
async function getUserFollowing(userId, token) {
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/api/follow/${userId}/following`, {
        method: 'GET',
        ...token && {
            token
        }
...
//# sourceMappingURL=_5baf7707._.js.map