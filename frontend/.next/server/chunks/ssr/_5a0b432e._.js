...
function LoginPage() {
    ...
    const { setSession } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthContext"])();
    ...
    const handleSignUp = async (e)=>{
        ...
        setLoading(true);
        try {
            const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signUp"])({
                name: signUpName,
                email: signUpEmail,
            ...
            const description = error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] ? error.message : error?.message || 'Failed to sign up';
            toast({
    ...
    const handleSignIn = async (e)=>{
        ...
        setLoading(true);
        try {
            const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"])({
                email: signInEmail,
            ...
            const description = error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] ? error.message : error?.message || 'Failed to sign in';
            toast({
...
//# sourceMappingURL=_5a0b432e._.js.map