            ...
            const fetchProfileData = {
                "ProfilePage.useEffect.fetchProfileData": async ()=>{
                    ...
                    try {
                        ...
                        setError(null);
                        // Fetch user stats
                        const statsData = await apiRequest('/api/users/me', {
                            method: 'GET',
                            token
                        });
                        setUserStats(statsData);
                        // Fetch user's posts
                        const postsData = await apiRequest('/api/posts/me', {
                            method: 'GET',
                            token
                        });
...
_s(ProfilePage, "qm9ES9UC9TL20vtMUdFn+D5kQYo=", false, function() {
    return [
...
//# sourceMappingURL=_a41bb8ba._.js.map