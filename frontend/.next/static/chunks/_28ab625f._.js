...
function PostCard({ post }) {
    ...
    const timeAgo = timestamp ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(timestamp, {
        addSuffix: true
    }) : 'just now';
...
function Feed() {
    ...
    const loadPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Feed.useCallback[loadPosts]": async ()=>{
            try {
                setIsLoading(true);
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$posts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPosts"])();
                setPosts(data);
            } catch (error) {
                const description = error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"] ? error.message : error?.message || 'Failed to load posts';
                toast({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Feed.useEffect": ()=>{
            const handler = {
                "Feed.useEffect.handler": ()=>loadPosts()
            }["Feed.useEffect.handler"];
            window.addEventListener('posts:refresh', handler);
            return ({
                "Feed.useEffect": ()=>window.removeEventListener('posts:refresh', handler)
            })["Feed.useEffect"];
        }
    }["Feed.useEffect"], [
        loadPosts
...
_s(Feed, "LSVj2WgJ6DkVUBhDkmgplZBu3QE=", false, function() {
    return [
...
//# sourceMappingURL=_28ab625f._.js.map